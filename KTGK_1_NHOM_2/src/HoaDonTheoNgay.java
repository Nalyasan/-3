...
public class HoaDonTheoNgay extends HoaDon {
	...
	HoaDonTheoNgay(int _maHoaDon, LocalDateTime _ngayHoaDon, String _tenKhachHang, String _maPhong, double _donGia,
			LocalDateTime _gioIn, LocalDateTime _gioOut, int _soNgayThue,double _thang) {
		super(_maHoaDon, _ngayHoaDon, _tenKhachHang, _maPhong, _donGia, _gioIn, _gioOut,_thang);
